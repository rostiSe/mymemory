...
ALTER TABLE "space_suggestions" ADD CONSTRAINT "space_suggestions_entry_id_entries_id_fk" FOREIGN KEY ("entry_id") REFERENCES "public"."entries"("id") ON DELETE cascade ON UPDATE no action;